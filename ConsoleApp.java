...
public class ConsoleApp {
    ...
    private JComboBox<String> genreBox, decadeBox, languageBox, moodBox;
    ...
    private void initializeUI() {
        frame = new JFrame("Neo Movie Recommendations");
        ...
        comboBox.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                if (isSelected) {
                    ...
                    c.setForeground(Color.BLACK); // Changed to black as requested
                }
                return c;
            }
        });
    ...
    private JPanel createMoviePanel(Movie movie) {
        ...
        detailsButton.setPreferredSize(new Dimension(150, 40));
    ...
    private void showMovieDetails(Movie movie) {
     ...
     // Cast panel
        ...
        JTextArea castTextArea = new JTextArea(movie.getCast());
        ...
        JLabel descTitleLabel = new JLabel("SYNOPSIS");
        ...
        JTextArea descTextArea = new JTextArea(movie.getDescription());
        ...
        // Add the panels to center panel
        JPanel detailsWrapper = new JPanel(new GridLayout(2, 1, 0, 20));
        detailsWrapper.setBackground(backgroundColor);
        detailsWrapper.add(castPanel);
        detailsWrapper.add(descPanel);
        centerPanel.add(detailsWrapper, BorderLayout.CENTER);
